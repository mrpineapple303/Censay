...
abang='\033[31;1m'
echo ""
figlet "Pineapple_303 Tools"|lolcat
echo "\033[33;1m|=====================|"
echo "\033[31;1m|+Author:Pineapple_303   +"
echo "\033[32;1m|+Team:|-L4EFY-|                +"
...
echo "===================================================="|lolcat
echo "17. Exit / About Creator"|lolcat
echo "===================================================="|lolcat
read -p "Root@pineapple_303~#" zal
...
sleep 0.5
echo""
echo $abang "Salam kenal dari gresik"
sleep 0.1
echo "Nitip salam gan"
sleep 0.1
echo "I LOVE YOU CENNY ARMELIA PUTRI"
sleep 0.1
echo ""
echo $ijo "Terima kasih telah berkunjung^_^"
sleep 5
fi
clear
